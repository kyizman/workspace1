...
public class TestCircleWithPrivateDataFields {
 ...
 //create a circle with a radius of 40
 ...
 // Increase myCircle's radius by 50%
 yourCircle.setRadius(yourCircle.getRadius() * 1.5);
 System.out.println("The area of your circle of radius " + yourCircle.getRadius() + " is " + yourCircle.getArea());
